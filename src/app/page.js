    ...
    <main className="w-full h-fit">
      ...
      <section className="h-fit bg-background grid content-around p-4 xl:grid-cols-2 xl:grid-rows-1 xl:items-center 2xl:justify-items-center 2xl:pr-28 ">
        ...
        <div className="  2xl:pl-14">
          <h1 className="red-text-gradient text-transparent bg-clip-text text-[2.5rem] font-extrabold tracking-tight leading-[3rem] text-center mb-10 xl:text-center 2xl:text-6xl 2xl:text-left">
            Generate mindblowing Images and NFTs with the power of Stable
            Diffusion.
          </h1>
          <p className="text-lg leading-7 font-medium text-center mb-10 md:p-4 xl:px-8 xl:text-center xl:mb-0 xl:p-[0_1rem_0_0] 2xl:text-xl 2xl:text-left 2xl:p-0">
