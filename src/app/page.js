  ...
  return (
    <main className="w-full h-full">
      <section className="flex flex-col justify-center items-center w-full h-screen p-4">
        <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight text-center  bg-clip-text text-transparent bg-gradient-to-tr purple-text-gradient lg:text-5xl 2xl:text-6xl">
        ...
        <Button variant="custom">
          <Link href="https://minertiaxyz.netlify.app">GET STARTED</Link>
        </Button>
      </section>
      ...
      <section className="w-full min-h-screen bg-blue-gradient  flex justify-center items-center">
        <div className=" flex flex-col justify-center items-center p-4 gap-16 2xl:gap-[6rem]">
          ...
          <div className="text-center">
            ...
            <Button>
              <Link href="https://minertiaxyz.netlify.app">TRY NOW</Link>
            </Button>
          </div>
        </div>
      </section>
